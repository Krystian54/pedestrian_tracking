...
# parametry
hog_ratio = 0.1 *           1    * 2
dst_ratio = 1/(1920/3) *    0.5  * 0.5
speed_ratio = 1/(1920/3) *  0.5  * 0.5
cost_threshold = 3
max_age = 120
...
out = cv2.VideoWriter('results/hungarian_alg.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (frame_width, frame_height))
