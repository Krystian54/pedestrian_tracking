...
def main():
    ...
    input_path = st.text_input("Ścieżka do filmu wejściowego", 
        "c:/Users/kamil/OneDrive/Pulpit/IO/pedestrian_tracking-kglod/input/film5_cutted.mp4")

    output_dir = st.text_input("Katalog na film wyjściowy", 
        "c:/Users/kamil/OneDrive/Pulpit/IO/pedestrian_tracking-kglod/output")
    ...
    if start ==  True:
        ...
        if selected_tab == "Bytetrack":
            set_bytetrack_parameters(
                path='C:/Users/kamil/OneDrive/Pulpit/IO/pedestrian_tracking-kglod/pedestrian_tracking-kglod/gui_functionality/bytetrack.yaml',
